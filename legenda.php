<html>
        ...
        <img src="images/red.png" width="20" height="20" alt="Multiple Retrys/No Responce" /> - Multiple retry's and no response. Server is likely to be down.<br /><hr />
        <img src="images/ani_install.gif" alt="Updating Now" /> - Server was send a _restart because it was out of date. It's updating now.<br /><hr />
        ...
        <img src="images/outofdate.png" alt="Out of Date" /> - Version is not the latest, but settings dont allow automatic update. You must do this manualy!<br /><hr />
		...
		<img src="images/sad.gif" alt="Master Server Problem" /> -  Master server is still advertising a older version, while the servers have a newer version already.<br /><hr />
